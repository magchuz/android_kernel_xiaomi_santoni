...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Wno-attribute-alias -O2 -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = -O2
...
KBUILD_CFLAGS	+= $(call cc-disable-warning,Wnonnull)
